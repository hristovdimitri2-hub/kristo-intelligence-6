...
**Доказателство на живо:** първата продажба беше допълнена с `paid_at =
2026-09-16T08:56:08+00:00` (точно `event.created`) и `checkout_id =
cs_live_a14DQkU4yfws5IMIZ1v5cs8UVbw0gh8kwjzvXJzfGn16dkscLZrBsojexK` — от
сверените Stripe данни, не по догадка.
